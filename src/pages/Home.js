...
export const Home = () => {
  ...
  return (
    ...
    <div>  
      ...
      <section id="hero-section" className="bg-white dark:bg-black dark:text-white"
      ...
      <section>
        <div className="container">
          <div className="py-20 md:flex md:flex-row justify-center items-center md:gap-10 md:w-full">
            ...
            <div className="text-center md:w-1/2 md:text-center pt-5" data-aos="zoom-in-up" data-aos-duration="800">
