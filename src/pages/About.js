                    ...
                    <div className="py-10 ">
                        <div className="container1">
                            ...
                            <div className="flex" data-aos="zoom-in" data-aos-duration="700">
                                <button  className={`px-7 py-[4px] sm:px-10 sm:py-[8px] font-bold  hover:dark:text-white ${activeCategory === "all" ? 'bg-secondary text-white dark:text-white' : ''}`} onClick={() => handleCategoryClick("all")}>
                                    All
                                </button>
                                <button className={`px-2 sm:px-4 font-bold   hover:dark:text-white ${activeCategory === 'frontend' ? 'bg-secondary text-white dark:text-white' : ''}`} onClick={() => handleCategoryClick("frontend")}>
                                    frontend
                                </button>
                                <button className={`px-3 sm:px-5 font-bold   hover:dark:text-white ${activeCategory === 'backend' ? 'bg-secondary text-white dark:text-white' : ''}`} onClick={() => handleCategoryClick("backend")}>
                                    backend
                                </button>
                                <button className={`px-6 sm:px-8 font-bold   hover:dark:text-white ${activeCategory === 'others' ? 'bg-secondary text-white dark:text-white ' : ''}`} onClick={() => handleCategoryClick("others")}>
                                    tools
                                </button>
